...
class Wallet {
    ...
    initMiningSection() {
        $.getJSON("https://node1.aintcoin.org/node/status", function (data) {
    ...
    //     $.getJSON("https://node1.aintcoin.org/node/status", function (data) {
    //         var currentHeight = data.blockchainHeight;
    //         $.getJSON("https://node1.aintcoin.org/addresses/data/3ANzidsKXn9a1s9FEbWA19hnMgV9zZ2RB9a?key=" + wallet.address, function (data) {
    //             if (data.length > 0) {
    ...
    async loadAintInfo() {
        $.getJSON("https://node1.aintcoin.org/addresses/data/3ANmnLHt8mR9c36mdfQVpBtxUs8z1mMAHQW", function (data) {
        ...
        $.getJSON("https://node1.aintcoin.org/assets/balance/3ANmnLHt8mR9c36mdfQVpBtxUs8z1mMAHQW/9tZso8WvrB2YR5SA7RyCnsLcKjTZBGtQq49Js8cczeyb", function (data) {
    ...
    async populateTokens() {
        var tokenData;
        await $.getJSON("https://node1.aintcoin.org/addresses/data/3ADqaKZpZrEEBSjZKqNemWrG3jzYUdUUYpi", function(data) {
            tokenData = data;
        });

        $.getJSON("https://node1.aintcoin.org/assets/balance/" + this.address, function(data) {
    ...
    private async initWaves(seed) {
        this.signer = new Signer({
            NODE_URL: 'https://node1.aintcoin.org',
        });
    ...
    async populateAlphaBalance() {
        ...
        // $.getJSON("https://node1.aintcoin.org/addresses/data/3ANzidsKXn9a1s9FEbWA19hnMgV9zZ2RB9a", function(data){
        //     data.forEach(function (entry) {
        //         try {
    ...
    async getAdNumber() {
        $.getJSON("https://node1.aintcoin.org/addresses/data/3ANmnLHt8mR9c36mdfQVpBtxUs8z1mMAHQW/%25s__adnum", function (data) {
            $("#buttonCode").attr("href", "https://t.me/AnoteAds/" + data.value);
        });
    }

    private async checkAlias() {
        $.getJSON("https://node1.aintcoin.org/alias/by-address/" + this.address, function (data) {
            if (data.length > 0) {
    ...
    private async populateStaking() {
        ...
        $.getJSON("https://node1.aintcoin.org/addresses/data/3A9y1Zy78DDApbQWXKxonXxci6DvnJnnNZD?key=" + stakingKey, function (data) {
            ...
            $.getJSON("https://mobile.aintchain.com/miner/" + wallet.address, function (data) {
                ...
                $.getJSON("https://node1.aintcoin.org/addresses/data/3AR11vcAeEfWFMTKbcxTo79LcbH7uSmhftZ?key=" + stakingKey, function (data1) {
        ...
        $.getJSON("https://node1.aintcoin.org/addresses/data/3AR11vcAeEfWFMTKbcxTo79LcbH7uSmhftZ?key=" + stakingKey, function (data) {
            var amountStaked = 0.0;
            if (data.length > 0) {
                amountStaked = parseFloat(data[0].value.split("__")[1]) / 100000000;
            }
        ...
        $.getJSON("https://node1.aintcoin.org/addresses/data/3AVTze8bR1SqqMKv3uLedrnqCuWpdU7GZwX", function (data) {
    ...
    private async checkReferral() {
        if (this.referral && this.referral.length > 0 && !this.referral.startsWith("3A") && this.referral != undefined) {
            $.getJSON("https://node1.aintcoin.org/alias/by-alias/" + this.referral, function (data) {
                if (data.address) {
